...
if (isset($_SESSION['logged']) && $_SESSION['logged'] == true) {
    $mes = $dbh->prepare('SELECT id_sender, id_receiver, firstname, lastname, u.id as "id_user" FROM direct_messages INNER JOIN users u ON u.id = direct_messages.id_sender WHERE id_receiver = :id');
    $mes->execute(array(
        'id' => $_SESSION['id']
    ));
