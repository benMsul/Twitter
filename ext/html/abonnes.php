            ...
            <div class="text-start mt-2 border-bottom">
                <div class="d-flex">
                    ...
                    <div class="d-flex flex-column ms-3">
                        <span class="fw-bold accueil ms-2"><?= $_SESSION['firstname'] . " " . $_SESSION['lastname'] ?></span>
                        <span class="accueil ms-2 userTweetPosted">@<?= $_SESSION['firstname'] . $_SESSION['lastname'] ?></span>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-around align-items-center">
                <a class="tendancesContent w-50 p-2 activeTabs" href="../html/abonnes.php">
                    <span>Abonnés</span>
                </a>
                <a class="tendancesContent w-50 p-2 " href="../html/abonne.php">
                    <span>Abonné</span>
                </a>
            </div>
            <div id="response">
            ...
            <div class="mt-3 tendancesBox text-start">
                ...
                <div class="tendancesContent p-3 d-flex align-item-center">
                    <div class="d-flex align-item-center">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <span class="tendancesReasons"> Ruben Ribeiro</span>
                            <span class="tendancesText">@Ruben_Ribeiro</span>
                        </div>
                    </div>
